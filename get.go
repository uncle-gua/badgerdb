...
// Get retrieves a value from badgerdb and puts it into result.  Result must be a pointer
...
// TxGet allows you to pass in your own badger transaction to retrieve a value from the badgerdb and puts it
// into result
...
// Find retrieves a set of values from the badgerdb that matches the passed in query
...
// TxFind allows you to pass in your own badger transaction to retrieve a set of values from the badgerdb
...
// TxFindOne allows you to pass in your own badger transaction to retrieve a single record from the badgerdb
