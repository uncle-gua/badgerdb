...
var nestedTests = []test{
	{
		name:   "Nested",
		query:  badgerdb.Where("L1.Name").Eq("Joe"),
		result: []int{0},
	},
	{
		name:   "Embedded",
		query:  badgerdb.Where("Color").Eq("red"),
		result: []int{0, 1},
	},
	{
		name:   "Embedded Explicit",
		query:  badgerdb.Where("Embed.Color").Eq("red"),
		result: []int{0, 1},
	},
	{
		name:   "Nested Multiple Levels",
		query:  badgerdb.Where("L2.L3.Name").Eq("Joe"),
		result: []int{0, 3},
	},
	{
		name:   "Pointer",
		query:  badgerdb.Where("Pointer.Name").Eq("Jill"),
		result: []int{1, 2, 3},
	},
	{
		name:   "Sort",
		query:  badgerdb.Where("Key").Ge(0).SortBy("L2.L3.Name"),
		result: []int{4, 1, 2, 0, 3},
	},
	{
		name:   "Sort On Pointer",
		query:  badgerdb.Where("Key").Ge(0).SortBy("Pointer.Name"),
		result: []int{4, 1, 2, 0, 3},
	},
}
